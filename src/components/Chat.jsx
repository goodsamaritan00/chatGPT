  ...
  return (
    <div className={styles.chat}>
      ...
      <form onSubmit={(e) => {
        ...
        <button disabled={question.length < 0 && true} style={{ background: question.length > 0 && '#00A67E' }}><BiSend style={{ color: question.length > 0 && 'white' }} className={styles.searchIcon} /></button>
      </form>
    </div>
  )
}
